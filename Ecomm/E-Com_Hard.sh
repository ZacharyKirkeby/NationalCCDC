...
#ptables -A INPUT -m state --state NEW -m limit --limit 20/second --limit-burst 5 -j ACCEPT
...
iptables -A OUTPUT -p tcp --dport 3306 -m state --state ESTABLISHED,RELATED -j ACCEPT
